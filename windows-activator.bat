...
:ato
echo ============================================================================&echo.&echo.&cscript //nologo slmgr.vbs /ato | find /i "successfully" && (echo.&echo ============================================================================&echo.&echo #My official blog: merostudy.xyz/blogs&echo.&echo #How it works: bit.ly/kms-server&echo.&echo #Please feel free to contact me at contact@merostudy.xyz if you have any questions or concerns.&echo.&echo #Please consider supporting this project: merostudy.xyz/donate&echo #Your support is helping me keep my servers running 24/7!&echo.&echo ============================================================================&choice /n /c YN /m "Would you like to visit my blog [Y,N]?" & if errorlevel 2 exit) || (echo The connection to my KMS server failed! Trying to connect to another one... & echo Please wait... & echo. & echo. & set /a i+=1 & goto skms)
explorer "http://merostudy.xyz/blogs"&goto halt
:notsupported
